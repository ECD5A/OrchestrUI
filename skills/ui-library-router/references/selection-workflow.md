...
1. Build `HostProfile`: framework and relevant versions, package manager, design system, component primitives, chart stack, motion stack, token sources and accessibility constraints.
...
4. Review role ownership and evidence. Keep the host system as owner wherever it already satisfies the role, and reject candidates incompatible with the host framework.
